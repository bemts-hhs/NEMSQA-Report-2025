...
export_nemsqa_data(pattern = "airway_01_pop", measure = "Airway-01", folder = "population")

### results exports ############################################################

export_nemsqa_data(pattern = "airway_01_result", measure = "Airway-01", folder = "result")
