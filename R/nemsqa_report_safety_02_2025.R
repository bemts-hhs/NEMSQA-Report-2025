...
# counties
safety_02_result_counties <- nemsqar::safety_02(df = NULL,
...
export_nemsqa_data(pattern = "safety_02_pop", measure = "Safety-02", folder = "population")

### results exports ############################################################

export_nemsqa_data(pattern = "safety_02_result", measure = "Safety-02", folder = "result")
