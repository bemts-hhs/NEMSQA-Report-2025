### IOWA NEMSQA REPORT TRAUMA-04 2025 ------------------------------------
...
trauma_04_pop <- trauma_04_population(df = NULL,
                                      ...
                                      edisposition_23_col = HOSPITAL_CAPABILITY_LIST_3_4_IT_DISPOSITION_105_3_5_E_DISPOSITION_23,
...
# 2021
trauma_04_pop_2021 <- trauma_04_population(df = NULL,
...
trauma_04_pop_filter_process_2021 <- trauma_04_pop_2021$filter_process |>
  dplyr::mutate(YEAR = 2021)

# 2022
trauma_04_pop_2022 <- trauma_04_population(df = NULL,
...
trauma_04_pop_filter_process_2022 <- trauma_04_pop_2022$filter_process |>
  dplyr::mutate(YEAR = 2022)

# 2023
trauma_04_pop_2023 <- trauma_04_population(df = NULL,
...
trauma_04_pop_filter_process_2023 <- trauma_04_pop_2023$filter_process |>
  dplyr::mutate(YEAR = 2023)

# 2024
trauma_04_pop_2024 <- trauma_04_population(df = NULL,
...
trauma_04_pop_filter_process_2024 <- trauma_04_pop_2024$filter_process |>
  dplyr::mutate(YEAR = 2024)

# airway-18 populations over the years
trauma_04_pop_years <- dplyr::bind_rows(trauma_04_pop_filter_process_2021,
                                        trauma_04_pop_filter_process_2022,
                                        trauma_04_pop_filter_process_2023,
                                        trauma_04_pop_filter_process_2024
                                        )
...
# year
trauma_04_result_year <- nemsqar::trauma_04(df = NULL,
                                            patient_scene_table = patient_scene_table,
                                            response_table = response_table,
                                            situation_table = situation_table,
                                            vitals_table = vitals_table,
...
# regions and years
trauma_04_result_regions_years <- nemsqar::trauma_04(df = NULL,
                                                     patient_scene_table = patient_scene_table,
                                                     response_table = response_table,
                                                     situation_table = situation_table,
                                                     vitals_table = vitals_table,
...
# regions
trauma_04_result_regions <- nemsqar::trauma_04(df = NULL,
                                               patient_scene_table = patient_scene_table,
                                               response_table = response_table,
                                               situation_table = situation_table,
                                               vitals_table = vitals_table,
...
# counties
trauma_04_result_counties <- nemsqar::trauma_04(df = NULL,
...
# overall
trauma_04_result_overall <- nemsqar::trauma_04(df = NULL,
                                               patient_scene_table = patient_scene_table,
                                               response_table = response_table,
                                               situation_table = situation_table,
                                               vitals_table = vitals_table,
...
export_nemsqa_data(pattern = "trauma_04_pop", measure = "Trauma-04", folder = "population")

### results exports ############################################################

export_nemsqa_data(pattern = "trauma_04_result", measure = "Trauma-04", folder = "result")
