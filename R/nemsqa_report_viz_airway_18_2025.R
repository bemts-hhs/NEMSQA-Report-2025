...
# save the table
export_nemsqa_gt(gt_object = airway_18_pop_gt, measure = "Airway-18", folder = "pop", extension = "png")
...
# save the table
export_nemsqa_gt(gt_object = airway_18_results_gt, measure = "Airway-18", folder = "result", extension = "png")
...
airway_18_result_counties_map <- results_to_county_map(df = airway_18_result_counties, add_text = FALSE, format = "percent")

# save the plot
ggplot2::ggsave(filename = "airway_18_result_counties_map.png", plot = airway_18_result_counties_map, path = "C:/Users/nfoss0/OneDrive - State of Iowa HHS/Analytics/BEMTS/NEMSQA Report/2025/output/Airway-18/result",
                width = 7, height = 7
                )
