...
# NEMSQA Report 2025 <img src="man/figures/HHS PFP 5.png" align="right" width="250" alt="" />
...
The NEMSQA Report 2025 analyzes National EMS Quality Alliance (NEMSQA)
...
This report is completed by the Bureau of Emergency Medical and Trauma
Services (BEMTS) epidemiologist to gauge Iowa EMS agencys’ performance
against the NEMSQA national benchmarks. In this way, BEMTS can assess
patient care quality using standardized measures. The {`nemsqar`}
package facilitates easy measure calculation for continuous quality
improvement.

BEMTS exists within the Division of Public Health at Iowa Department of
...
| **Measure ID** | **Description** | **Type** | **National Quality Strategy Domain** |
|----|----|----|----|
